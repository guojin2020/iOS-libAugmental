...
-(NSInteger)pickerView:(UIPickerView*)pickerView numberOfRowsInComponent:(NSInteger)component
{
	switch(component)
	{
		case 0: return [monthStrings count];
		case 1: return [yearStrings count];
		default: return -1;
	}
}
...
-(NSString*)pickerView:(UIPickerView*)pickerView titleForRow:(NSInteger)row forComponent:(NSInteger)component
{
	switch(component)
	{
		case 0: return [monthStrings objectAtIndex:row];
		case 1: return [yearStrings objectAtIndex:row];
		default: return nil;
	}
}
