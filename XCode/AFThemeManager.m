...
+(void)addObserver:(NSObject<AFThemeObserver>*)observerIn{[observers addObject:observerIn];}
+(void)removeObserver:(NSObject<AFThemeObserver>*)observerIn{[observers removeObject:observerIn];}
...
+(void)setCurrentTheme:(NSDictionary*)newTheme
{
    ...
    for(NSObject<AFThemeObserver>* observer in observers){[observer themeChanged];}
}
...
-(BOOL)boolForKey:(NSString*)key{       return [(NSNumber*)[self valueForKey:key] boolValue];}
-(BOOL)floatForKey:(NSString*)key{      return [(NSNumber*)[self valueForKey:key] floatValue];}
-(UIColor*)colorForKey:(NSString*)key{  return [UIColor colorWithHexString:[self valueForKey:key]];}
-(UIImage*)imageForKey:(NSString*)key{	return [AFImageCache image:[self valueForKey:key]];}
