...
-(AFPage*)currentPage{return (AFPage*)[pages objectAtIndex:[[navController viewControllers]count]-1];}
...
-(AFPage*)pageAtIndex:(int)pageIndex{return (AFPage*)[pages objectAtIndex:pageIndex];}

-(void)addObserver:(NSObject<AFPageObserver>*)observerIn{[observers addObject:observerIn];}
-(void)removeObserver:(NSObject<AFPageObserver>*)observerIn{[observers removeObject:observerIn];}
...
-(void)viewControllerChanged:(AFPage*)page was:(UIViewController*)oldViewController
{
	...
	for(NSObject<AFPageObserver>* observer in observers){[observer viewControllerChanged:page was:oldViewController];}
}

-(void)nextButtonPressed{[self navigateToNextPageAnimated:YES];}

-(int)indexOfPage:(AFPage*)page{return [pages indexOfObject:page];}

-(void)backButtonPressed{[self navigateToPreviousPageAnimated:YES];}
...
-(AFPage*)rootPage{return [self pageAtIndex:0];}
...
-(NSEnumerator*)pageEnumerator{return [pages objectEnumerator];}
