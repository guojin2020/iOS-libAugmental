...
-(void)themeChanged{}
+(Class<AFThemeable>)themeParentSectionClass{return [AFScreen class];}
+(NSString*)themeSectionName{return nil;} //@"onlineScreen"
+(NSDictionary*)defaultThemeSection{return [NSDictionary dictionary];}
