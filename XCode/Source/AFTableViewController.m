...
-(void)setTable:(AFTable*)tableIn
{
	...
	[oldTable removeObserver:self];
	[tableIn addObserver:self];
	[oldTable release];
	//[self editableChanged:table];
	table.parentController = self;
...
-(void)editableChanged:(AFBlockEditableObject*)changedTable
{
...
{
	if(table)[[table sectionAtIndex:indexPath.section] beginBlockEdit];
}

-(void)tableView:(UITableView*)tableView didEndEditingRowAtIndexPath:(NSIndexPath*)indexPath
{
	if(table)[[table sectionAtIndex:indexPath.section] endBlockEdit];
}
