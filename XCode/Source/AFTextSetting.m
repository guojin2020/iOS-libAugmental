...
-(void)textFieldDidBeginEditing:(UITextField*)textFieldIn
{
	...
	[self.parentSection.parentTable.parentController textFieldDidBeginEditing:textFieldIn];
...
{
	[self.parentSection.parentTable.parentController textFieldDidEndEditing:textFieldIn];
...
+(NSString*)themeSectionName{return @"textSetting";}
