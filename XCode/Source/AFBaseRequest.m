...
-(void)addObserver:(NSObject<AFRequestObserver>*)newObserver{[observers addObject:newObserver];}
-(void)removeObserver:(NSObject<AFRequestObserver>*)oldObserver{[observers removeObject:oldObserver];}
