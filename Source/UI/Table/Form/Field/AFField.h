...
@protocol AFField <AFValidatable>
...
/**
 This method provides a common selector for the UI controls on the UIViewCells of all AFField
 implementations.
...
/**
 Update the appearance of the UIViewCell managed by this AFField implementation,
